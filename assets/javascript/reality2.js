// Corrected relative paths to step up out of the pages/ directory and into the images/ folder
...
// Adjusted the loop to match up with next01, next02, and next03 listeners
for(let i = 1; i < 4; i++)
{
